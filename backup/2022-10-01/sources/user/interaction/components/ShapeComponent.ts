...
export class ShapeComponent extends Component {
	...
	constructor(name?: string, parent?: Item, data?: any) {
		...
		// let pose = this._entity.pose;
		// pose.position.relativeValues.x.value = 100000;
		
		let pose = this._entity.pose = new GeoPoseBasicYPR("pose", this._entity);
		pose.position.altitude.value = 0;
