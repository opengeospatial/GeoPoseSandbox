...
/** Defines an advanced GeoPose. */
export class GeoPoseAdvanced extends GeoPose {

	// -------------------------------------------------------- PUBLIC METADATA

	/** The data type associated to the GeoPoseAdvanced class. */
	public static type: Type = new Type("geopose-advanced", GeoPoseAdvanced, 
		GeoPose.type);
