...
export class PlanetWidget extends Widget {
	...
	constructor(name?: string, parent?: Item, data: any = {}) { 
		...
		if (data.atmosphere)this._atmosphere = new AtmosphereEntity(
			name + "Atmosphere", this._entity , data);
		if (data.graticule) this._graticule = new GraticuleEntity(
			name + "Graticule", this._entity, data);
